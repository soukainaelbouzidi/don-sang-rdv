...
const MesRendezVousContainer = () => {
  ...
  const handleDeleteRendezVous = async (id) => {
    try {
      await axios.delete(`https://aa9f-105-66-133-87.ngrok-free.app/rdv/${id}`);
  ...
  const handleDownloadRendezVous = (item) => {
    ...
    navigation.navigate('ValidationRdv', { rendezvousData: item });
  };
...
export default MesRendezVousContainer;
